...
function renderSkill(skill: SkillStatusEntry, props: SkillsProps) {
  ...
  const showBundledBadge = Boolean(skill.bundled && skill.source !== "openpollen-bundled");
      ...
      <div class="list-main">
          ...
          missing.length > 0
            ? html`
              <div class="muted" style="margin-top: 6px;">
                ${t('skills.missingLabel', { items: missing.join(", ") })}
              </div>
            `
            : nothing
        }
        ${
          reasons.length > 0
            ? html`
              <div class="muted" style="margin-top: 6px;">
                ${t('skills.reasonLabel', { items: reasons.join(", ") })}
              </div>
            `
            : nothing
        }
