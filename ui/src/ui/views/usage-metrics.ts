      ...
      <div class="card usage-mosaic">
        <div class="usage-mosaic-header">
          <div>
            ...
            <div class="usage-mosaic-sub">${t('usage.estimateRequire')}</div>
          </div>
          <div class="usage-mosaic-total">${formatTokens(0)} ${t('usage.tokensSuffix')}</div>
        </div>
        <div class="muted" style="padding: 12px; text-align: center;">${t('usage.noTimelineYet')}</div>
      </div>
    `;
  }
      ...
      <div class="usage-mosaic-header">
        <div>
          ...
          <div class="usage-mosaic-sub">
            ${t('usage.estimatedFromSpans', { tz: timeZone === "utc" ? "UTC" : t('usage.localTz') })}
          </div>
        </div>
        <div class="usage-mosaic-total">${formatTokens(stats.totalTokens)} ${t('usage.tokensSuffix')}</div>
      </div>
