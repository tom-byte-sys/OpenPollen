...
function renderEntry(entry: PresenceEntry) {
  const lastInput = entry.lastInputSeconds != null ? t('instances.agoSuffix', { seconds: entry.lastInputSeconds }) : t('common.na');
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${entry.host ?? t('common.unknown')}</div>
      ...
      <div class="list-meta">
        ...
        <div class="muted">${t('instances.lastInputLabel')} ${lastInput}</div>
        <div class="muted">${t('instances.reasonLabel')} ${entry.reason ?? ""}</div>
      </div>
    </div>
  `;
}
