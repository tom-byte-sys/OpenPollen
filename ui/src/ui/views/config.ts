      ...
      <aside class="config-sidebar">
        ...
        <div class="config-search">
          ...
          <input
            ...
            placeholder=${t('config.searchSettingsPlaceholder')}
        ...
        <nav class="config-nav">
          ...
          >
            ...
            <span class="config-nav__label">${t('config.allSettingsLabel')}</span>
          </button>
          ${allSections.map(
            (section) => html`
              <button
              ...
              hasChanges
                ? html`
                  <span class="config-changes-badge"
                    >${
                      props.formMode === "raw"
                        ? t('config.unsavedChangesRaw')
                        : t('config.unsavedChangesCount', { count: diff.length })
                    }</span
                  >
                `
                : html`
            ...
            ? html`
              <details class="config-diff">
                <summary class="config-diff__summary">
                  <span
                    >${t('config.viewPendingChanges', { count: diff.length })}</span
                  >
                  <svg
                  ...
                  props.schemaLoading
                    ? html`
                        <div class="config-loading">
                          ...
                          <span>${t('config.loadingSchemaLabel')}</span>
                        </div>
                      `
                    : renderConfigForm({
