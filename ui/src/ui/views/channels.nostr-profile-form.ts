  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">${t('channels.nostr.editProfileTitle')}</div>
        <div style="font-size: 12px; color: var(--text-muted);">${t('channels.nostr.accountPrefix', { accountId })}</div>
      </div>
      ...
      ${renderField("name", t('channels.nostr.username'), {
        placeholder: t('channels.nostr.usernamePlaceholder'),
        maxLength: 256,
        help: t('channels.nostr.usernameHelp'),
      })}

      ${renderField("displayName", t('channels.nostr.displayNameField'), {
        placeholder: t('channels.nostr.displayNamePlaceholder'),
        maxLength: 256,
      ...
      ${renderField("picture", t('channels.nostr.avatarUrl'), {
        type: "url",
        placeholder: t('channels.nostr.avatarPlaceholder'),
          ...
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              ...
              ${renderField("banner", t('channels.nostr.bannerUrl'), {
                type: "url",
                placeholder: t('channels.nostr.bannerPlaceholder'),
                help: t('channels.nostr.bannerHelp'),
              })}

              ${renderField("website", t('channels.nostr.website'), {
                type: "url",
                placeholder: t('channels.nostr.websitePlaceholder'),
                help: t('channels.nostr.websiteHelp'),
              })}

              ${renderField("nip05", t('channels.nostr.nip05Field'), {
                placeholder: t('channels.nostr.nip05Placeholder'),
                help: t('channels.nostr.nip05Help'),
              })}

              ${renderField("lud16", t('channels.nostr.lightning'), {
                placeholder: t('channels.nostr.lightningPlaceholder'),
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t('channels.nostr.saving') : t('channels.nostr.savePublish')}
        </button>
        ...
        >
          ${state.importing ? t('channels.nostr.importing') : t('channels.nostr.importRelays')}
        </button>
