...
function getSecurityOptions(): Array<{ value: ExecSecurity; label: string }> {
  return [
    { value: "deny", label: t('execApprovals.securityDeny') },
    { value: "allowlist", label: t('execApprovals.securityAllowlist') },
    { value: "full", label: t('execApprovals.securityFull') },
  ];
}

function getAskOptions(): Array<{ value: ExecAsk; label: string }> {
  return [
    { value: "off", label: t('execApprovals.askOff') },
    { value: "on-miss", label: t('execApprovals.askOnMiss') },
    { value: "always", label: t('execApprovals.askAlways') },
  ];
}
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            ${t('execApprovals.subtitle')} <span class="mono">exec host=gateway/node</span>.
          </div>
        </div>
        <button
          class="btn"
          ...
          @click=${state.onSave}
        >
          ${state.saving ? t('execApprovals.saving') : t('common.save')}
        </button>
      </div>
        ...
        !ready
          ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.loading || !targetReady} @click=${state.onLoad}>
              ${state.loading ? t('execApprovals.loadingButton') : t('execApprovals.loadButton')}
            </button>
          </div>`
          : html`
...
function renderExecApprovalsPolicy(state: ExecApprovalsState) {
  ...
  return html`
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t('execApprovals.securityTitle')}</div>
          <div class="list-sub">
            ${isDefaults ? t('execApprovals.defaultSecurityMode') : t('execApprovals.defaultValue', { value: defaults.security })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t('execApprovals.askTitle')}</div>
          <div class="list-sub">
            ${isDefaults ? t('execApprovals.defaultPromptPolicy') : t('execApprovals.defaultValue', { value: defaults.ask })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t('execApprovals.autoAllowTitle')}</div>
          <div class="list-sub">
            ${
              isDefaults
                ? t('execApprovals.autoAllowSub')
                : autoIsDefault
                  ? t('execApprovals.autoAllowDefault', { value: defaults.autoAllowSkills ? 'on' : 'off' })
                  : t('execApprovals.autoAllowOverride', { value: autoEffective ? 'on' : 'off' })
            }
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
            <span>${t('execApprovals.enabledLabel')}</span>
            <input
              type="checkbox"
              ?disabled=${state.disabled}
          ...
          ${
            !isDefaults && !autoIsDefault
              ...
              >
                ${t('execApprovals.useDefaultButton')}
              </button>`
              : nothing
          }
        </div>
...
function renderExecApprovalsAllowlist(state: ExecApprovalsState) {
  ...
  return html`
    <div class="row" style="margin-top: 18px; justify-content: space-between;">
      <div>
        <div class="card-title">${t('execApprovals.allowlist')}</div>
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">${t('execApprovals.lastUsed', { time: lastUsed })}</div>
